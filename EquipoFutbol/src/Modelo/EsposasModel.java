 ...
 * @author basto
 */
public class EsposasModel extends FutbolistaModel {
    ...
    public EsposasModel(long IdEsposa, String NombreEsposa, String ApellidoEsposa, int EdadEsposa, int DorsalLigado, String NombreEsposo) {
    ...
    public EsposasModel(long IdEsposa, String NombreEsposa, String ApellidoEsposa, int EdadEsposa, int DorsalLigado, String NombreEsposo, long IdFutbolista, String NombreFutbolista, String ApellidoFutbolista, int EdadFutbolista, int NumeroCamisa, String PuestoEnElCampo) {
    ...
    public EsposasModel(long IdEsposa, String NombreEsposa, String ApellidoEsposa, int EdadEsposa, int DorsalLigado, String NombreEsposo, long IdFutbolista, String NombreFutbolista, String ApellidoFutbolista, int EdadFutbolista, int NumeroCamisa, String PuestoEnElCampo, long Id, String Nombre, String Apellido, int Edad) {
