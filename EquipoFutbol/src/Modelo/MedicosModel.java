 ...
 * @author basto
 */
public class MedicosModel extends Campo_entrenamientoModel {
    ...
    public MedicosModel(long IdMedico, String NombreMedico, String ApellidoMedico, int EdadMedico, String FechaAtencion, String HoraAtencion) {
    ...
    public MedicosModel(long IdMedico, String NombreMedico, String ApellidoMedico, int EdadMedico, String FechaAtencion, String HoraAtencion, long Id, String Nombre, String Apellido, int Edad) {
    ...
    public void Concentracion(ArrayList<FutbolistaModel> futbolistas) {
