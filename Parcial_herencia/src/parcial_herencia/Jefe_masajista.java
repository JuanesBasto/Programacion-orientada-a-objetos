 ...
 * @author basto
 */
public class Jefe_masajista extends Campo_entrenamiento {
    ...
    public Jefe_masajista(long IdJefe, String NombreJefeM, String ApellidoJefeM, int EdadJefeMAguatero, String Observaciones) {
        this.IdJefe = IdJefe;
    ...
    public Jefe_masajista(long IdJefe, String NombreJefeM, String ApellidoJefeM, int EdadJefeMAguatero, String Observaciones, long Id, String Nombre, String Apellido, int Edad) {
