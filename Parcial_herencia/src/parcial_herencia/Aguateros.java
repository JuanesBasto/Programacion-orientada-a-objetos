...
public class Aguateros extends Campo_entrenamiento {
    ...
    public Aguateros(long IdAguatero, String NombreAguatero, String ApellidoAguatero, int EdadAguatero, int NumeroChaleco) {
    ...
    public Aguateros(long IdAguatero, String NombreAguatero, String ApellidoAguatero, int EdadAguatero, int NumeroChaleco, long Id, String Nombre, String Apellido, int Edad) {
    ...
    public void ServirAgua(ArrayList<Futbolistas> futbolistas) {
