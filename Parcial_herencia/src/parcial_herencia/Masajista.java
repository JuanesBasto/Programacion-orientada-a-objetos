...
public class Masajista extends Jefe_masajista {
    ...
    public Masajista(long IdMasajista, String NombreMasajista, String ApellidoMasajista, int EdadMasajista, String TituloUniversitario, int AñosDeExperiencia) {
    ...
    public Masajista(long IdMasajista, String NombreMasajista, String ApellidoMasajista, int EdadMasajista, String TituloUniversitario, int AñosDeExperiencia, long IdJefe, String NombreJefeM, String ApellidoJefeM, int EdadJefeMAguatero, String Observaciones) {
    ...
    public Masajista(long IdMasajista, String NombreMasajista, String ApellidoMasajista, int EdadMasajista, String TituloUniversitario, int AñosDeExperiencia, long IdJefe, String NombreJefeM, String ApellidoJefeM, int EdadJefeMAguatero, String Observaciones, long Id, String Nombre, String Apellido, int Edad) {
